...
#' Fit time series model with brm
#' @description fit_ts_model_with_brm() is a Fit function that fits a model of a specified type to a dataset Specifically, this function implements an algorithm to fit time series model with brm. The function returns Model (a list).
#' @param data_tb Data (a tibble)
...
{
    mdl_ls <- brms::brm(formula = stats::as.formula(paste0(dep_var_nm_1L_chr, 
