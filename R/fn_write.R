...
#' @param rprt_type_ls Rprt type (a list)
...
#' @param nm_of_mkdn_dir_1L_chr Name of mkdn directory (a character vector of length one), Default: 'Markdown'
#' @param path_to_rprt_dir_1L_chr Path to rprt directory (a character vector of length one), Default: './'
...
#' @param path_to_outpt_dir_1L_chr Path to outpt directory (a character vector of length one), Default: '../../../../Data/Project/Utility_Models'
...
write_rprt <- function (rprt_type_ls, outp_smry_ls, output_type_1L_chr = "PDF", 
    section_type_1L_chr = "#", path_to_outpt_dir_1L_chr = "../../../../Data/Project/Utility_Models", 
