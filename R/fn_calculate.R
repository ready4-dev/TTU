...
#' @description calculate_aqol6d_d1_disu_dbl() is a Calculate function that calculates a numeric value. Specifically, this function implements an algorithm to calculate aqol6d d1 disu. The function returns dvd1 (a double vector of length 1).
#' @param dvQs_tb DvQs (a tibble)
#' @param kD_1L_dbl KD 1L (a double vector of length 1)
#' @param w_dbl W (a double vector of length 1)
#' @return DvD1 (a double vector of length 1)
...
calculate_aqol6d_d1_disu_dbl <- function (dvQs_tb, kD_1L_dbl, w_dbl) 
{
    dvD1_dbl <- purrr::pmap_dbl(dvQs_tb, ~{
        (1/kD_1L_dbl) * ((1 + (kD_1L_dbl * w_dbl[1] * ..1)) * 
            ...
            w_dbl[3] * ..2)) * (1 + (kD_1L_dbl * w_dbl[4] * ..4)) - 
            1)
    })
    return(dvD1_dbl)
}
#' Calculate aqol6d d2 disu
#' @description calculate_aqol6d_d2_disu_dbl() is a Calculate function that calculates a numeric value. Specifically, this function implements an algorithm to calculate aqol6d d2 disu. The function returns dvd2 (a double vector of length 1).
#' @param dvQs_tb DvQs (a tibble)
#' @param kD_1L_dbl KD 1L (a double vector of length 1)
#' @param w_dbl W (a double vector of length 1)
#' @return DvD2 (a double vector of length 1)
...
#' @description calculate_aqol6d_d3_disu_dbl() is a Calculate function that calculates a numeric value. Specifically, this function implements an algorithm to calculate aqol6d d3 disu. The function returns dvd3 (a double vector of length 1).
#' @param dvQs_tb DvQs (a tibble)
#' @param kD_1L_dbl KD 1L (a double vector of length 1)
#' @param w_dbl W (a double vector of length 1)
#' @return DvD3 (a double vector of length 1)
...
#' @description calculate_aqol6d_d4_disu_dbl() is a Calculate function that calculates a numeric value. Specifically, this function implements an algorithm to calculate aqol6d d4 disu. The function returns dvd4 (a double vector of length 1).
#' @param dvQs_tb DvQs (a tibble)
#' @param kD_1L_dbl KD 1L (a double vector of length 1)
#' @param w_dbl W (a double vector of length 1)
#' @return DvD4 (a double vector of length 1)
...
#' @description calculate_aqol6d_d5_disu_dbl() is a Calculate function that calculates a numeric value. Specifically, this function implements an algorithm to calculate aqol6d d5 disu. The function returns dvd5 (a double vector of length 1).
#' @param dvQs_tb DvQs (a tibble)
#' @param kD_1L_dbl KD 1L (a double vector of length 1)
#' @param w_dbl W (a double vector of length 1)
#' @return DvD5 (a double vector of length 1)
...
#' @description calculate_aqol6d_d6_disu_dbl() is a Calculate function that calculates a numeric value. Specifically, this function implements an algorithm to calculate aqol6d d6 disu. The function returns dvd6 (a double vector of length 1).
#' @param dvQs_tb DvQs (a tibble)
#' @param kD_1L_dbl KD 1L (a double vector of length 1)
#' @param w_dbl W (a double vector of length 1)
#' @return DvD6 (a double vector of length 1)
...
#' Calculate aqol6dU
#' @description calculate_aqol6dU_dbl() is a Calculate function that calculates a numeric value. Specifically, this function implements an algorithm to calculate aqol6dU. The function returns aqol6du (a double vector of length 1).
...
#' @return Aqol6dU (a double vector of length 1)
