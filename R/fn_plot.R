...
#' @param depnt_var_desc_1L_chr Dependent variable description (a character vector of length one), Default: 'AQoL-6D utility score'
...
#' @keywords internal
plot_lnr_cmprsn <- function (data_tb, predn_ds_tb, depnt_var_nm_1L_chr = "aqol6d_total_w", 
    predr_var_nm_1L_chr, depnt_var_desc_1L_chr = "AQoL-6D utility score", 
...
#' @keywords internal
plot_obsd_predd_dnst <- function (tfd_data_tb, depnt_var_desc_1L_chr = "AQoL-6D utility score", 
...
#' @keywords internal
plot_obsd_predd_sctr_cmprsn <- function (tfd_data_tb, depnt_var_nm_1L_chr = "aqol6d_total_w", 
    depnt_var_desc_1L_chr = "AQoL-6D utility score", round_var_nm_1L_chr = "round", 
...
#' @importFrom rlang sym
#' @keywords internal
plot_sctr_plt_cmprsn <- function (tfd_data_tb, depnt_var_nm_1L_chr = "aqol6d_total_w", 
    predd_val_var_nm_1L_chr = "Predicted") 
{
