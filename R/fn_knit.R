...
#' @param path_to_mdl_rprt_tmpl_1L_chr Path to mdl rprt tmpl (a character vector of length one), Default: system.file("_Model_Report_Template.Rmd", package = "FBaqol")
#' @return NULL
