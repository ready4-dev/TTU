...
if(!is.na(params$path_to_data_1L_chr)){
  ...
  raw_data_tb <- ready4u::replication_popl_tb
}
...
path_to_write_to_1L_chr <- paste0(path_to_write_fls_to_1L_chr,
                                                      "/",
                                                      dir_nm_1L_chr)
if(!dir.exists(path_to_write_fls_to_1L_chr))
  dir.create(path_to_write_fls_to_1L_chr)
...
outp_smry_ls <- write_all_alg_outps(scored_data_tb = scored_data_tb,
...
```{r eval=T}
add_utility_predn_to_ds(data_tb = outp_smry_ls$fk_data_tb,
