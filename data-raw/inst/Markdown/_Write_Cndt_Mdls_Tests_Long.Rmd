...
```{r}
bl_tb <- TTU::transform_ds_for_tstng(data_tb, 
...
```{r message=FALSE, warning=F}
    mdl_smry_ls$smry_of_mdl_sngl_predrs_tb <- TTU::write_mdl_type_multi_outps(data_tb = bl_tb,
        ...
        path_to_write_to_1L_chr = output_data_dir_1L_chr, new_dir_nm_1L_chr = "C_Predrs_Sngl_Mdl_Cmprsns",
...
```{r}
bl_tb <- data_tb %>% TTU::transform_ds_for_tstng(candidate_predrs_chr = ds_smry_ls$candidate_predrs_chr,
