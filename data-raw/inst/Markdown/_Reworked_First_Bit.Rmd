...
bl_tb <- transform_ds_for_tstng(data_tb, depnt_var_nm_1L_chr = depnt_var_nm_1L_chr, candidate_predrs_chr = candidate_predrs_chr, dep_var_max_val_1L_dbl = 0.999, round_val_1L_chr = "Baseline")
```
...
smry_of_mdl_sngl_predrs_tb <- write_mdl_type_multi_outps(data_tb = bl_tb,
                            folds_1L_int = folds_1L_int,
                            predrs_var_nms_chr = predr_cmprsn_tb$predr_chr,
