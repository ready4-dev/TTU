...
pkg_dss_tb <- tibble::tibble(short_name_chr = c("coefs","hetg",
                               ...
                               long_name_chr = c("population level effects",
                                                 ...
                                                 "comparative scatter plot of obsereved and predictions using mean model parameter values",
                                                 "comparative densities of observed data and predictions using sampled model parameter values",
                                                 "comparative scatter plot of obsereved and predictions using sampled model parameter values",
                                                 ...
                                                 "comparative scatter plot of obsereved and predictions using mean model parameter values and transformation of out of range predictions to upper and lower bounds",
                                                 ...
                                                 "comparative scatter plot of obsereved and predictions using sampled model parameter values and transformation of out of range predictions to upper and lower bounds")) %>%
