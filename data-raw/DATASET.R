  ...
  dplyr::bind_rows(ready4class::make_pt_ready4class_constructor(make_s3_lgl = FALSE,
                   ...
                   ready4class::make_pt_ready4class_constructor(make_s3_lgl = FALSE,
                                                                ...
                                                                pt_ls = list("TTUSynopsis",
                                                                             ...
                                                                             "character",
                                                                             "list") %>% list(),
                                                                vals_ls = list(list(catalogue_tmpl_chr = "c(\"https://github.com/ready4-dev/ttu_mdl_ctlg\",\"0.0.9.6\")", #### UPDATE ###
                                                                                    ...
                                                                                    manuscript_tmpl_chr = "c(\"https://github.com/ready4-dev/ttu_lng_ss\",\"0.7.0.0\")",
