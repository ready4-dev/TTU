...
pkg_dss_tb <- ready4fun::write_abbr_lup(short_name_chr = c("adol","aqol","aqol6d","aqol6dU","con","cnstr","dim","disv","eq","lgd","q","scrg","tot","uid","ut","unscrd","vldn"),
...
fns_dmt_tb <- ready4fun::make_dmt_for_all_fns(paths_ls = ready4fun::make_fn_nms()[1],
                                              ...
                                              custom_dmt_ls = list(details_ls = NULL,
                                                                   inc_for_main_user_lgl_ls = list(force_true_chr = c("add_aqol6d_items_to_tbs_ls","add_aqol_scores_tbs_ls",
                                                                                                                      ...
                                                                                                                      "add_corrs_and_uts_to_tbs_ls_ls","add_dim_disv_to_aqol6d_items_tb",
                                                                                                                      ...
                                                                                                                      "make_vec_with_sum_of_int", "randomise_change_in_fct_var",
