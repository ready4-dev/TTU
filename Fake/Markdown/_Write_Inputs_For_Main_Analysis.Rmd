...
```{r echo = (is.null(params_ls$fake_ds_tb) & paths_ls$write_to_dir_nm_1L_chr == "Fake" & params_ls$rprt_type_1L_chr == "Analysis"), eval = (is.null(params_ls$fake_ds_tb) & paths_ls$write_to_dir_nm_1L_chr == "Fake" & params_ls$rprt_type_1L_chr == "Analysis")}
saveRDS(youthvars::replication_popl_tb, here::here(paths_ls$path_to_fake_data_1L_chr))
```

```{r echo = (!is.null(params_ls$fake_ds_tb) & paths_ls$write_to_dir_nm_1L_chr == "Fake" & params_ls$rprt_type_1L_chr == "Analysis"), eval = (!is.null(params_ls$fake_ds_tb) & paths_ls$write_to_dir_nm_1L_chr == "Fake" & params_ls$rprt_type_1L_chr == "Analysis")}
saveRDS(params_ls$fake_ds_tb, here::here(paths_ls$path_to_fake_data_1L_chr))
```
