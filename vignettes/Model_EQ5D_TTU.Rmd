...
```{r message=FALSE}
data_tb <- readxl::read_excel(system.file("extdata", "eq5d5l_example.xlsx", package="eq5d")) %>% 
  dplyr::mutate(total_eq5d = eq5d::eq5d(., country="UK", version = "5L", type = "CW"))
...
We also require a data dictionary for our input dataset. The dictionary must be of the `ready4use::ready4_dictionary` class.
