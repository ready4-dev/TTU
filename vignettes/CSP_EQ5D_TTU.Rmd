...
## Report results
The following function call authors a [report, summarising all the transfer to utility models](https://dataverse.harvard.edu/api/access/datafile/4806542) and writes it to a local directory along with other supplementary reporting information. 
```{r echo = TRUE, eval=FALSE }
