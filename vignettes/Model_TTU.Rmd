...
write.csv(youthvars::replication_popl_tb %>% dplyr::select(-BADS,-GAD7, -OASIS,-SCARED),"Data/data.csv", row.names=FALSE)
write.csv(youthvars::repln_ds_dict_r3,"Data/dictionary.csv", row.names=FALSE)
```
