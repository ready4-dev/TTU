...
fit_ts_model_with_brm <- function(data_tb,
  ...
  write_brm_mdl_tiff <- function(plt_fn,
                                 ...
                                 height_1L_dbl = 6, 
                                 rsl_1L_dbl = 300){
    path_to_plot_1L_chr <- paste0(path_to_write_to_1L_chr,"/",mdl_nm_1L_chr,".tiff")           
    grDevices::tiff(path_to_plot_1L_chr, 
                    units = units_1L_chr, 
                    width = width_1L_dbl, 
...
write_brm_model_plts <- function(mdl_ls,
                           ...
                           width_dbl = c(rep(5,2),rep(6,2)),
                           rsl_dbl = rep(300,4),
                           args_ls = NULL,
                           seed_1L_dbl = 23456){
  set.seed(seed_1L_dbl)
  data_tb$Predicted <- predict(mdl_ls)[,1] %>% tfmn_fn()
  mdl_plts_paths_ls <- purrr::map(1:4, 
              ~  {
                if(.x %in% c(1,2)){
                  plt_fn <- function(){plot(mdl_ls, ask=F, plot = F)[.x]}
                }else{
                  if(.x == 3){
                     plt_fn <- function(){data_tb %>% 
                     ...
                     plt_fn <- function(){ggplot2::ggplot(data_tb) +
                       rlang::exec(plot3_fn,
                ...
                write_brm_mdl_tiff(plt_fn,
                                   path_to_write_to_1L_chr = path_to_write_to_1L_chr,
                                   mdl_nm_1L_chr = paste0(mdl_nm_1L_chr,"_",.x),
...
make_smry_of_ts_mdl <- function(data_tb,
  ...
  smry_of_ts_mdl_tb <- make_smry_of_brm_mdl(mdl_ls,
                                            data_tb = tfd_data_tb,
                                            dep_var_nm_1L_chr = tfd_dep_var_nm_1L_chr,
                                            predictor_vars_nms_chr = predictor_vars_nms_chr,
  ...
  if(!is.na(path_to_write_to_1L_chr)){
    saveRDS(mdl_ls,paste0(path_to_write_to_1L_chr,"/",mdl_nm_1L_chr,".RDS"))
    mdl_plts_ls <- write_brm_model_plts(mdl_ls,
                                     tfd_data_tb,
                                     dep_var_nm_1L_chr = dep_var_nm_1L_chr, 
                                     mdl_nm_1L_chr = mdl_nm_1L_chr,
                                     path_to_write_to_1L_chr = path_to_write_to_1L_chr,
...
if(print_plots_1L_lgl){
  ...
  print_brm_model(mdl_ls,
                  brm_model_plts_ls = mdl_plts_ls,
                  mdl_nm_1L_chr = mdl_nm_1L_chr)
}
return(smry_of_ts_mdl_tb)
}
