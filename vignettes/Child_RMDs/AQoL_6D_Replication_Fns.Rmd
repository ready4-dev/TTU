...
write_and_make_smry_of_ts_mdl <- function(data_tb,
    ...
    args_ls <- list(data_tb = tfd_data_tb,
                    dep_var_nm_1L_chr = dep_var_nm_1L_chr, # ADD CONDITIONAL LOGIC
                    predictor_vars_nms_chr = predictor_vars_nms_chr,
                    iters_1L_int = iters_1L_int,
                    seed_1L_int = seed_1L_int)
  ...
  smry_of_ts_mdl_tb <- make_smry_of_brm_mdl(mdl_ls,
                                            ...
                                            fn = ifelse(identical(fn,fit_gsn_log_lnk),
                                                        calculate_rmse,
                                                        calculate_rmse_tfmn)#, mdl_nm_1L_chr = mdl_nm_1L_chr
                                            )
  write_ts_mdl(mdl_ls,
               data_tb = tfd_data_tb,
               dep_var_nm_1L_chr = dep_var_nm_1L_chr,
...
if(print_plots_1L_lgl){
  mdl_1_plts_ls <- make_brm_model_plts(mdl_ls,
                                       tfd_data_tb,
                                       tfmn_fn = ifelse(identical(fn,fit_gsn_log_lnk),
                                                        function(x){x},
                                                        function(x){1-exp(-exp(x))}))
  print_brm_model(mdl_ls,mdl_1_plts_ls)
}
...
saveRDS(cnfdl_mdl_ls,paste0(path_to_data_dir_1L_chr,"/",mdl_nm_1L_chr,".RDS"))
}
