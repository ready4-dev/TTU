...
write_one_predr_mdl_plts <- function(data_tb,
  ...
  predn_ds_tb <- make_predn_ds_with_one_predr(mdl, predr_var_nm_1L_chr = predr_var_nm_1L_chr, predr_vals_dbl = predr_vals_dbl)
  purrr::pwalk(list(plt_fn_ls = list(plot_lnr_cmprsn, ggplot2::autoplot, plot_obsd_predd_dnst, plot_obsd_predd_dnst, plot_sctr_lnr_cmprsn),
            ...
            ~ write_brm_mdl_plt_fl(plt_fn = ..1,
                     ...
                     plt_nm_1L_chr = paste0(predr_var_nm_1L_chr,
                                            ..3)))
...
write_one_predr_mdl_outp <- function(data_tb,
                                     ...
                                     mdl_nm_1L_chr = "OLS (no transformation)",
                                     mdl_fl_nm_1L_chr){
  mdl <- make_one_predr_mdl(data_tb,predr_var_nm_1L_chr = predr_var_nm_1L_chr, mdl_type_1L_chr = mdl_type_1L_chr)
  write_one_predr_mdl_plts(data_tb,
                         ...
                         path_to_write_to_1L_chr = path_to_write_to_1L_chr)
make_smry_of_one_predr_mdl(data_tb,
                           mdl,
                           folds_ls,
                           predr_var_nm_1L_chr = predr_var_nm_1L_chr,
                           mdl_type_1L_chr = mdl_type_1L_chr,
...
```{r}
data_tb <- baseline
folds_ls <- caret::createFolds(baseline$aqol6d_total_w , k = 10, list = TRUE, returnTrain = FALSE)
