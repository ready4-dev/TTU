...
data_tb <- data_tb %>%
  dplyr::mutate(dplyr::across(where(is.numeric), 
                              ~ round(., digits = digits_1L_dbl) %>% as.character())) 
}
...
# data_tb <- brms_mdl_print_ls[[5]]$data_tb
# brms_mdl_print_ls[[5]]$output_type_1L_chr -> output_type_1L_chr
# brms_mdl_print_ls[[5]]$caption_1L_chr -> caption_1L_chr
# brms_mdl_print_ls[[5]]$label -> label
# brms_mdl_print_ls[[5]]$merge_row_idx_int -> merge_row_idx_int
# brms_mdl_print_ls[[5]]$digits_dbl -> digits_dbl
# brms_mdl_print_ls[[5]]$hline.after -> hline.after
# brms_mdl_print_ls[[5]]$sanitize_fn ->  sanitize_fn
# brms_mdl_print_ls[[5]]$footnotes_chr -> footnotes_chr
#  if(output_type_1L_chr == "HTML"){
  # data_kb <- data_tb %>%
  #   kableExtra::kable(format = "html",escape = F,
  #       caption = caption_1L_chr) %>%
