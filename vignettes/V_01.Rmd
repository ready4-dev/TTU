...
A <- renew(A, what_1L_chr = "utility") # A <- renewSlot(A, "a_ScorzProfile")
```
...
```{r}
A <- renew(A, fl_nm_1L_chr = "predictors_r3", type_1L_chr = "predictors_lup", 
...
authorReport(procureSlot(A, "d_TTUReports") %>%
             ...
             consent_1L_chr = consent_1L_chr, fl_nm_1L_chr = "Supplement", what_1L_chr = "Manuscript_Submission") 
```
...
```{r eval = F}
authorSlot(A,"c_SpecificProject", type_1L_chr = "purge_write") 
