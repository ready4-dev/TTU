...
A <- renewSlot(A, "c_SpecificProject", 
               authorSlot(A, "c_SpecificProject", consent_1L_chr = consent_1L_chr, what_1L_chr = "workspace"))
```
...
A <- renewSlot(A, "c_SpecificProject",
               authorSlot(A, "c_SpecificProject", consent_1L_chr = consent_1L_chr, 
                          digits_1L_int = 3L, what_1L_chr = "descriptives"))
```
...
```{r message=FALSE, results='hide', warning=FALSE}
A <- renewSlot(A, "c_SpecificProject",
               investigateSlot(A,"c_SpecificProject", consent_1L_chr = consent_1L_chr))
```
...
```{r eval =F}
A <- renewSlot(A, "c_SpecificProject",
               authorData(procureSlot(A, "c_SpecificProject"), consent_1L_chr = consent_1L_chr))
```
...
```{r eval =F}
authorSlot(A, "d_TTUReports", consent_1L_chr = consent_1L_chr, download_tmpl_1L_lgl = T, what_1L_chr = "Catalogue")
```
...
```{r eval =F}
shareSlot(A, "d_TTUReports@a_TTUSynopsis", consent_1L_chr = consent_1L_chr,  type_1L_chr = "Report", what_1L_chr = "Catalogue") 
```
...
```{r eval =F}
shareSlot(A, "d_TTUReports@a_TTUSynopsis", consent_1L_chr = consent_1L_chr, type_1L_chr = "Models", what_1L_chr = "ingredients")
```
...
```{r eval =F}
authorSlot(A, "d_TTUReports", consent_1L_chr = consent_1L_chr,
...
```{r eval =F}
authorSlot(A, "d_TTUReports", consent_1L_chr = consent_1L_chr, type_1L_chr = "Report", what_1L_chr = "Manuscript_Auto", download_tmpl_1L_lgl = T)
```
...
authorSlot(A, "d_TTUReports", consent_1L_chr = consent_1L_chr, what_1L_chr = "Manuscript_Submission", download_tmpl_1L_lgl = F)
```
