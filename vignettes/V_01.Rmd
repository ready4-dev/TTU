...
```{r}
R.utils::copyDirectory(paste0(C@a_TTUSynopsis@a_Ready4showPaths@outp_data_dir_1L_chr,
                              "/",
                              C@a_TTUSynopsis@a_Ready4showPaths@mkdn_data_dir_1L_chr,
                              "/Manuscript_Auto"),
                       paste0(C@a_TTUSynopsis@a_Ready4showPaths@outp_data_dir_1L_chr,
                              "/",
                              C@a_TTUSynopsis@a_Ready4showPaths@mkdn_data_dir_1L_chr,
...
authorReport(C %>%
               ...
               #download_tmpl_1L_lgl = F,
               what_1L_chr = "Manuscript_Submission") # ERROR
...
```{r}
author(B,
       type_1L_chr = "purge_write") # Authors (again?) catalogue. ???
```
