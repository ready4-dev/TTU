...
```{r}
write_results_to_csv(synth_data_spine_ls,
...
bl_part_2_tb <- tibble::tibble(fkClientID = aqol6d_adol_pop_tbs_ls$bl_outcomes_tb$fkClientID,
...
fup_part_2_tb <- bl_part_2_tb %>% 
  ...
  dplyr::mutate(round = 2,
                d_age = d_age + 0.25,
                Region = Region %>% randomise_change_in_fct_var(0.98),
                d_studying_working = d_studying_working %>% randomise_change_in_fct_var(0.9),
                c_p_diag_s = c_p_diag_s %>% randomise_change_in_fct_var(0.90),
                c_clinical_staging_s = c_clinical_staging_s %>% randomise_change_in_fct_var(0.8),
...
```{r}
bl_tb <- dplyr::inner_join(bl_part_2_tb,aqol6d_adol_pop_tbs_ls$bl_outcomes_tb) 
fup_tb <- dplyr::inner_join(fup_part_2_tb,aqol6d_adol_pop_tbs_ls$fup_outcomes_tb)
```
