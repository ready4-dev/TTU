...
### Secondary Analyses 
We can specify supplementary analyses (that apply the same preferred model types as the primary analysis to different combinations of candidate predictors and co-variates) by creating a new predictors lookup table and making a call to the `write_scndry_analysis` function.
